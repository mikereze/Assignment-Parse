 ...
 * @author xero
 */
public class GeneratorOfPaths{

    /**
     * @param args the command line arguments
     */
    
    static List<Object> allPaths = new ArrayList();
    static List<List<Object>> choosedPaths = new ArrayList();
    ...
    public static int getTypeOfStatement(String s){
        s = s.trim();
        int answer = -1;
        // 0 = normal statement
        // 1 = if statement
    ...
    public static String addIdentifier(String code){
        ...
        for(String token:tokens){
            token = token.trim();
            status = getTypeOfStatement(token);
            switch(status){
